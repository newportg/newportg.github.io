...
![PlantUml flowchart](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.github.com/newportg/newportg.github.io/assets/test1.puml)

Kf-GaryNewport/Kf-GaryNewport.github.io/master/assets/test1.puml)

A more complex example :-

```
![PlantUml flowchart](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.github.com/
newportg/newportg.github.io/assets/test.puml)
```
Kf-GaryNewport/Kf-GaryNewport.github.io/master/assets/test.puml)

![PlantUml flowchart](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.github.com/newportg/newportg.github.io//master/assets/test.puml)
